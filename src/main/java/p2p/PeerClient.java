...
public class PeerClient {
    ...
    public HttpResponse sendGet(String peerAddress, String path) throws IOException, URISyntaxException {
        return send("GET", peerAddress, path, null, null);
    }
    ...
    public HttpResponse sendPost(String peerAddress, String path, String body, String contentType) throws IOException, URISyntaxException {
        return send("POST", peerAddress, path, body, contentType);
    }

    public HttpResponse sendPut(String peerAddress, String path, String body, String contentType) throws IOException, URISyntaxException {
        return send("PUT", peerAddress, path, body, contentType);
    }

    public HttpResponse sendDelete(String peerAddress, String path, String body, String contentType) throws IOException, URISyntaxException {
        return send("DELETE", peerAddress, path, body, contentType);
    }

    private HttpResponse send(String method, String peerAddress, String path, String body, String contentType) throws IOException, URISyntaxException {
        ...
        try (Socket socket = new Socket(t.uri.getHost(), t.port)) {
            ...
            w.write(method + " " + t.path + " HTTP/1.1\r\n");
